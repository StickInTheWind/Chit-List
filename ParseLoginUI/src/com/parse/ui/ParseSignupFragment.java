...
public class ParseSignupFragment extends ParseLoginFragmentBase implements OnClickListener {
  ...
  private EditText lastNameField; //Added 5/17/15 Larry Parsons
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup parent,
    ...
    firstNameField = (EditText) v.findViewById(R.id.signup_firstName_input);
    lastNameField = (EditText) v.findViewById(R.id.signup_lastName_input);
